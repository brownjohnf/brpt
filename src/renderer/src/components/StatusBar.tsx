...
export function StatusBar({
  ...
  return (
    <div
      className="h-7 flex items-center px-3 text-xs gap-2 border-t transition-colors duration-300 bg-[var(--status-bg)] border-[var(--status-border)] text-[var(--status-text)]"
    >
      {draggablePath && (
        <span
          draggable="true"
